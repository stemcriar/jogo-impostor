  ...
  return (
    <header className="w-full py-4 px-6 flex items-center justify-between bg-white border-b border-gray-100 shadow-sm sticky top-0 z-30">
      <div className="flex items-center gap-4">
        {showLogo && (
          <Link to="/mentor" onClick={handleLogoClick} className="flex-shrink-0">
            <img src="/jogo-impostor/stem-criar-logo.png" alt="STEM Criar" className="h-10 object-contain rounded-[10px]" />
          </Link>
        )}
        {title && (
