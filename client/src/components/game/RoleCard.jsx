  ...
  return (
    ...
    >
      ...
      >
        ...
        <div 
          className="absolute inset-0 backface-hidden w-full h-full bg-white rounded-2xl shadow-md border-2 border-purple-light flex flex-col items-center justify-center p-8 text-center"
        ...
        <div 
          className={`absolute inset-0 backface-hidden w-full h-full bg-white rounded-2xl shadow-md border-4 flex flex-col items-center justify-center p-8 text-center ${isMachine ? 'border-danger' : 'border-success'}`}
