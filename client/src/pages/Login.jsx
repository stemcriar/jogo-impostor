...
export default function Login() {
  const { isAuthenticated: isMentorAuth, login: loginMentor } = usePinAuth('mentor');
  const { isAuthenticated: isDashAuth, login: loginDash } = usePinAuth('dashboard');
  ...
  }, [isMentorAuth, isDashAuth, navigate]);
